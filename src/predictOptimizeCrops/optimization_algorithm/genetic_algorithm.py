...
def run_genetic_algorithm(crops, cost_per_m2, revenue_per_m2, total_area, total_budget, 
    ...
    stagnation_limit = 20  # Number of generations without significant improvement before stopping
    ...
    for generation in range(num_generations):
        ...
        if stagnation_counter >= stagnation_limit:
            logging.info(f"Early stopping at generation {generation} due to stagnation.")
            break
